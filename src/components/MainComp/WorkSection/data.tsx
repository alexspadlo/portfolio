const workSchema = {
    ...
    designSection: {
        ...
        subTitle: 'From the point of origin comes the idea, a scribble on paper, digitization and the end product. Each process is pure magic and it feels like I\'m not at work, but in an intellectual therapy to develop creativity and to be happy with myself. The act of creating those designs can be a way to bring people together, share something meaningful and beautiful with the world.'
    }
}
